...
<head>
    ...
    <link rel="stylesheet" href="../Styles/StyleArticlesTexte.css">
...
<div class="container">
    <div class="row">
        <div class="col block">
            ...
            <p>Les présentes CGU ou Conditions Générales d’Utilisation encadrent juridiquement l’utilisation des services du site Le Belfort (ci-après dénommé «
                <em> le site </em>»).
            </p>
            <p>Constituant le contrat entre la société Le Belfort, l’Utilisateur, l’accès au site doit être précédé de l’acceptation de ces CGU. L’accès à cette plateforme signifie l’acceptation des présentes CGU.</p>
        </div>
        <div class="col block">
            <h4>Article 2 : Mentions légales</h4>
            <p>L’édition du site Le Belfort est assurée par la société Le Belfort inscrite au RCS sous le numéro 123 456 789, dont le siège social est localisé au 16 rue Albert Thomas, 90000, Belfort, France Métropolitaine.</p>
        </div>
    </div>
    <div>
        <div class="col block">
            <h4>Article 3 : Accès au site</h4>
            <p>Le site Le Belfort permet d’accéder gratuitement aux services suivants :</p>
            <ul>
                <li>articles ;</li>
                <li>compte-utilisateur ;</li>
                <li>statistique d’utilisation</li>
            </ul>
    ...
    <div class="row">
        ...
        <div class="col block">
            ...
            <p>Les marques, logos ainsi que les contenus du site Le Belfort (illustrations graphiques, textes…) sont protégés par le Code de la propriété intellectuelle et par le droit d’auteur.</p>
    ...
    <div class="row">
        <div class="col block"><h4>Article 8 : Cookies</h4>
            ...
            <p>L’information présente dans les cookies est utilisée pour améliorer les performances de navigation sur le site LeBelfort.fr.</p>
        ...
        <div class="col block">
            ...
            <p>Le site Le Belfort permet aux membres de publier des commentaires.</p>
    ...
    <div class="row">
        ...
        <div class="col block"><h4>Article 11 : Droit applicable et juridiction compétente</h4>
